...
function isValidSpecialSymbol(charCode) {
	...
	if(charCode >= 0x2591 && charCode <= 0x2593) return false;
...
/* ============================================================
   1. Inject @font-face & Global Styles
   ============================================================ */
(function() {
    let css = `
@font-face {
    font-family: "Braille Octant Mono 2.4";
    src: url("https://cdn.jsdelivr.net/gh/brejeira21/Braille-Octant-Mono-Version-2.4-@main/BrailleOctantMono2.4.ttf") format("truetype");
}
body, #maincanvas, #drawing_canvas, #page_edit_textarea, #chat_input {
    font-family: "Braille Octant Mono 2.4", monospace !important;
}`;
...
/* ============================================================
   2. Path-Based Heavy Renderer
   ============================================================ */
function drawPatternBlock(ctx, x, y, width, height, rows, cols, code) {
    let p = BigInt(code);
    let totalBits = rows * cols;
    let cw = width / cols;
    let ch = height / rows;
 
    ctx.beginPath();
    for (let i = 0; i < totalBits; i++) {
        // Bit-shifting from MSB to LSB
        if ((p >> BigInt(totalBits - 1 - i)) & 1n) {
            let r = Math.floor(i / cols);
            let c = i % cols;
            ctx.rect(x + (c * cw), y + (r * ch), cw, ch);
        }
    }
    ctx.closePath();
    ctx.fill();
...
/* ============================================================
   3. Dispatcher (Corrected Syntax and Scope)
   ============================================================ */
const originalDispatcher = window.drawBlockChar;
 
window.drawBlockChar = function(char_code, ctx, x, y, width, height) {
    let code = 0n;
    let rows = 24; // Default rows
    let cols = 12; // Default cols
 
    switch(char_code) {
        /* Standard Block Shades */
        case 0x2591: code = 40462392486580401925097128832646235038037218487980076733146160316684749910772288170n; rows = 24; cols = 12; break;
        case 0x2592: code = 165814874526670381543630009999647856377159653890450813283786622513071972887263995845290n; rows = 24; cols = 12; break;
        case 0x2593: code = 165855346795257828760705621550641707746823257800771116709862563303197157283781904347135n; rows = 24; cols = 12; break;
 
        /* High-Density Symbols 0x1FB8C - 0x1FB94 */
        case 0x1FB8C: code = 163263876457029298750651086768884043202126428445982339233266828320563173304383011293824n; rows = 24; cols = 12; break;
        case 0x1FB8D: code = 2550998069641082792978923230763813175033225444468474050519794192508799582880984551466n; rows = 24; cols = 12; break;
        case 0x1FB8E: code = 165814874526670381543630009999647856377159646455054684117852716889984064554908170321920n; rows = 24; cols = 12; break;
        case 0x1FB8F: code = 7435396129165933905623087908332355825523370n; rows = 24; cols = 12; break;
        case 0x1FB90: code = 165814874526670381543630009999647856377159653890450813283786622513071972887263995845290n; rows = 24; cols = 12; break;
        case 0x1FB91: code = 497323236409786642155382248146820840100456135931998648075774740980529132696527695076010n; rows = 24; cols = 12; break;
        case 0x1FB92: code = 165814874526670381543630009999647856377159668755799882648475858425702337203269676302335n; rows = 24; cols = 12; break;
        case 0x1FB93: code = 492223107765431007376739906021479717273943896998780072761130479133465842795221538922474n; rows = 24; cols = 12; break;
        case 0x1FB94: code = 170915003171026016322272352124988979203671907689018457963120120272765627104575832455871n; rows = 24; cols = 12; break;
 
        /* Standard Block Shade Quadrants */
        case 0x1C00E: code = 163263876457029298750651086768884043202126421124976919746808828937830463561755736932352n; rows = 24; cols = 12; break;
        case 0x1C00F: code = 2550998069641082792978923230763813175033225330077764371043887952153600993152433389568n; rows = 24; cols = 12; break;
        case 0x1C010: code = 7321005419486457999382732709742627274361472n; rows = 24; cols = 12; break;
        case 0x1C011: code = 2550998069641082792978923230763813175033232651083183857501887334886310735779707751040n; rows = 24; cols = 12; break;
        case 0x1C012: code = 165814874526670381543630009999647856377159653776060103604310716272716774297535444683392n; rows = 24; cols = 12; break;
        case 0x1C013: code = 114390709679475906240355198589728551161898n; rows = 24; cols = 12; break;
        case 0x1C014: code = 163263876457029298750651086768884043202126421239367629426284735178185662151484288094250n; rows = 24; cols = 12; break;
        case 0x1C015: code = 165814874526670381543630009999647856377159646569445393797328623130339263144636721483818n; rows = 24; cols = 12; break;
        case 0x1C016: code = 163263876457029298750651086768884043202126428560373048912742734560918371894111562455722n; rows = 24; cols = 12; break;
        case 0x1C017: code = 2550998069641082792978923230763813175033232765473893536977793575241509325508258912938n; rows = 24; cols = 12; break;
        case 0x1C026: code = 492223107765431007376739906021479717273943882362128681386667231465645176391769792010922n; rows = 24; cols = 12; break;
        case 0x1C027: code = 170915003171026016322272352124988979203671907460320779972894132027955929192021898910378n; rows = 24; cols = 12; break;
        case 0x1C028: code = 165814874526670381543630009999647856377159668527102204658249870180892639290715742756842n; rows = 24; cols = 12; break;
        case 0x1C029: code = 170915003171026016322272352124988979203671922096972171347357379695776595595473645821930n; rows = 24; cols = 12; break;
        case 0x1C02A: code = 497323236409786642155382248146820840100456150568650039450237988648349799099979441987562n; rows = 24; cols = 12; break;
        case 0x1C02B: code = 165814874526670381543630009999647856377159654119148491274012610757881670799817929390783n; rows = 24; cols = 12; break;
        case 0x1C02C: code = 492223107765431007376739906021479717273943882590826359376893219710454874304323725556415n; rows = 24; cols = 12; break;
        case 0x1C02D: code = 497323236409786642155382248146820840100456136160696326066000729225338830609081628621503n; rows = 24; cols = 12; break;
        case 0x1C02E: code = 492223107765431007376739906021479717273943897227477750751356467378275540707775472467967n; rows = 24; cols = 12; break;
        case 0x1C02F: code = 170915003171026016322272352124988979203671922325669849337583367940586293508027579367423n; rows = 24; cols = 12; break;
 
        /* 4x4 Blocks, etc */
        case 0x1FB95: code = 42405n; rows = 4; cols = 4; break;
        case 0x1FB96: code = 23130n; rows = 4; cols = 4; break;
        case 0x1FB97: code = 5n; rows = 4; cols = 1; break;
        case 0x1FBFB: code = 10n; rows = 1; cols = 4; break;
        case 0x1FBFC: code = 5n; rows = 1; cols = 4; break;
        case 0x2429: code = 2779096485n; rows = 8; cols = 4; break;
        case 0x1CEB4: code = 1515870810n; rows = 8; cols = 4; break;
        case 0x1FB7C: code = 9259542123273814271n; rows = 8; cols = 8; break;
        case 0x1FB7D: code = 18410856566090662016n; rows = 8; cols = 8; break;
        case 0x1FB7E: code = 18374969058471772417n; rows = 8; cols = 8; break;
        case 0x1FB7F: code = 72340172838076927n; rows = 8; cols = 8; break;
        case 0x1C060: code = 9187201950435737344n; rows = 8; cols = 8; break;
        case 0x1C061: code = 35887507618889599n; rows = 8; cols = 8; break;
        case 0x1C062: code = 71775015237779198n; rows = 8; cols = 8; break;
        case 0x1C063: code = 18374403900871474688n; rows = 8; cols = 8; break;
        case 0x1C268: code = 34959n; rows = 4; cols = 4; break;
        case 0x1C269: code = 63624n; rows = 4; cols = 4; break;
        case 0x1C26A: code = 61713n; rows = 4; cols = 4; break;
        case 0x1C26B: code = 4383n; rows = 4; cols = 4; break;
        case 0x1C26C: code = 30576n; rows = 4; cols = 4; break;
        case 0x1C26D: code = 1911n; rows = 4; cols = 4; break;
        case 0x1C26E: code = 3822n; rows = 4; cols = 4; break;
        case 0x1C26F: code = 61152n; rows = 4; cols = 4; break;
        case 0x1C1A0: code = 23040n; rows = 4; cols = 4; break;
        case 0x1C1A1: code = 18504n; rows = 4; cols = 4; break;
        case 0x1C1A2: code = 90n; rows = 4; cols = 4; break;
        case 0x1C1A3: code = 4626n; rows = 4; cols = 4; break;
        case 0x1C1A4: code = 23295n; rows = 4; cols = 4; break;
        case 0x1C1A5: code = 31611n; rows = 4; cols = 4; break;
        case 0x1C1A6: code = 65370n; rows = 4; cols = 4; break;
        case 0x1C1A7: code = 57054n; rows = 4; cols = 4; break;
        case 0x1C1A8: code = 42240n; rows = 4; cols = 4; break;
        case 0x1C1A9: code = 33924n; rows = 4; cols = 4; break;
        case 0x1C1AA: code = 165n; rows = 4; cols = 4; break;
        case 0x1C1AB: code = 8481n; rows = 4; cols = 4; break;
        case 0x1C1AC: code = 42495n; rows = 4; cols = 4; break;
        case 0x1C1AD: code = 47031n; rows = 4; cols = 4; break;
        case 0x1C1AE: code = 65445n; rows = 4; cols = 4; break;
        case 0x1C1AF: code = 60909n; rows = 4; cols = 4; break;
        case 0x1CEB5: code = 170n; rows = 8; cols = 1; break;
        case 0x1CEB6: code = 85n; rows = 8; cols = 1; break;
        case 0x1C238: code = 170n; rows = 1; cols = 8; break;
        case 0x1C239: code = 85n; rows = 1; cols = 8; break;
        case 0x1C077: code = 1n; rows = 1; cols = 3; break;
        case 0x1C079: code = 3n; rows = 1; cols = 3; break;
        case 0x1FBCE: code = 6n; rows = 1; cols = 3; break;
        case 0x1FBCF: code = 4n; rows = 1; cols = 3; break;
        case 0x1C076: code = 2n; rows = 1; cols = 3; break;
        case 0x1C078: code = 5n; rows = 1; cols = 3; break;
        case 0x1C070: code = 4n; rows = 1; cols = 4; break;
        case 0x1C071: code = 2n; rows = 1; cols = 4; break;
        case 0x1C072: code = 6n; rows = 1; cols = 4; break;
        case 0x1C073: code = 9n; rows = 1; cols = 4; break;
        case 0x1C074: code = 13n; rows = 1; cols = 4; break;
        case 0x1C075: code = 11n; rows = 1; cols = 4; break;
        case 0x1FB80: code = 129n; rows = 8; cols = 1; break;
        case 0x1FB81: code = 169n; rows = 8; cols = 1; break;
        case 0x1FB9C: code = 165814874519433375534727847960321908314986212285058253288321197776449051660960906872832n; rows = 24; cols = 12; break;
        case 0x1FB9D: code = 165814874523051436827491766815113614808348153787901821561271022060270294527380629229568n; rows = 24; cols = 12; break;
        case 0x1FB9E: code = 7237006008902162039325948062173441605392559995465424736622921226303088972458n; rows = 24; cols = 12; break;
        case 0x1FB9F: code = 3618944716138243184534241568811500102548991722515600452801678359883366615722n; rows = 24; cols = 12; break;
        case 0x25A0: code = 6n; rows = 4; cols = 1; break;
        case 0x25A1: code = 105299445582155022520711643881215028094495434648494333145204654080n; rows = 24; cols = 12; break;
        case 0x1C292: code = 0x55555555555555n; rows = 8; cols = 7; break;
        case 0x1C293: code = 0xAAAAAAAAAAAAAAn; rows = 8; cols = 7; break;
        case 0x1C294: code = 0x6666n; rows = 8; cols = 2; break;
        case 0x1C295: code = 0x9999n; rows = 8; cols = 2; break;
        case 0x1C296: code = 0x55AAn; rows = 4; cols = 4; break;
        case 0x1C297: code = 0xAA55n; rows = 4; cols = 4; break;
        case 0x1C23A: code = 0x55AA55AA55AA55AAn; rows = 8; cols = 8; break;
        case 0x1C23B: code = 0xAA55AA55AA55AA55n; rows = 8; cols = 8; break;
        default:
            return originalDispatcher.apply(this, arguments);
    }
 
    drawPatternBlock(ctx, x, y, width, height, rows, cols, code);
};
 
/* ============================================================
   4. Calibration & Overrides
   ============================================================ */
window.isValidSpecialSymbol = (function(oldValid) {
    return function(char_code) {
        if ((char_code >= 0x2591 && char_code <= 0x2593) ||
            (char_code >= 0x1FB8C && char_code <= 0x1FB94) ||
            (char_code >= 0x1C00E && char_code <= 0x1C017) ||
            (char_code >= 0x1C026 && char_code <= 0x1C02F) ||
            (char_code >= 0x1FB7C && char_code <= 0x1FB7F) ||
            (char_code >= 0x1C060 && char_code <= 0x1C063) ||
            (char_code >= 0x1C268 && char_code <= 0x1C26F) ||
            (char_code >= 0x1C076 && char_code <= 0x1C079) ||
            (char_code >= 0x1FBCE && char_code <= 0x1FBCF) ||
            (char_code >= 0x1C070 && char_code <= 0x1C075) ||
            (char_code >= 0x1FB95 && char_code <= 0x1FB97) ||
            (char_code >= 0x1FB9C && char_code <= 0x1FB9F) ||
            (char_code >= 0x1FBFB && char_code <= 0x1FBFC) ||
            (char_code >= 0x1CEB5 && char_code <= 0x1CEB6) ||
            (char_code >= 0x1C238 && char_code <= 0x1C23B) ||
            (char_code >= 0x1C292 && char_code <= 0x1C297) ||
            (char_code == 0x2429 || char_code == 0x1CEB4) ||
            (char_code >= 0x1C1A0 && char_code <= 0x1C1AF) ||
            (char_code == 0x25A0 || char_code == 0x25A1)) {
            return true;
        }
        return oldValid(char_code);
    };
})(window.isValidSpecialSymbol);
 
// Force 15px Grid System
w.changeFont("$px 'Braille Octant Mono 2.4', monospace, legacycomputing");
 
// Update internal scale constants to match 15px grid
if (typeof updateScaleConsts === "function") {
    let rawFunc = updateScaleConsts.toString();
    let funcBody = rawFunc.match(/\{([\s\S]*)\}/)[1].replace(/16/g, "20");
    window.updateScaleConsts = new Function(funcBody);
    window.updateScaleConsts();
}
 
client_commands.gridsize(["10x20"]);
(function() {
    /* ============================================================
    ...
    /* ============================================================
       ...
       ============================================================ */
    if (window.w && w.chat && w.chat.registerCommand) {
        w.chat.registerCommand("b4", function(args) {
            let input = args[0];
            if (!input) return;
